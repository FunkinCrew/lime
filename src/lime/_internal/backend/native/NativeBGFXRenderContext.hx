...
class NativeBGFXRenderContext
{
	...
	public var STENCIL_NONE = 0x0000ff00;
	...
	public var CAPS_TEXTURE_COMPARE_RESERVED:Int64 = Int64.make(0x00000000, 0x00100000);
	...
	public var CAPS_VIDEO_DECODE:Int64 = Int64.make(0x00000002, 0x00000000); // !< Hardware video decode is supported.
	public var CAPS_VIEWPORT_LAYER_ARRAY:Int64 = Int64.make(0x00000004, 0x00000000);
	...
	public function setDynamicVertexBufferLayout(stream:Int, handle:BGFXDynamicVertexBuffer, startVertex:Int, numVertices:Int,
	...
	public function setTransientVertexBufferLayout(stream:Int, tvb:BGFXTransientVertexBuffer, startVertex:Int, numVertices:Int,
			layout:BGFXVertexLayoutHandle):Void
	{
		#if (lime_cffi && lime_bgfx && !macro)
	...
	public function submitIndirectIndexBuffer(id:Int, program:BGFXProgram, ixbh:BGFXIndirectBuffer, start:Int, ibh:BGFXIndexBuffer, numMax:Int, depth:Int,
			flags:Int):Void
	{
		#if (lime_cffi && lime_bgfx && !macro)
	...
	public function vertexConvert(dstLayout:BGFXVertexLayout, dstData:ArrayBufferView, srcLayout:BGFXVertexLayout, srcData:ArrayBufferView, num:Int = 1):Void
	{
		#if (lime_cffi && lime_bgfx && !macro)
	...
	public function topologyConvert(conversion:BGFXTopologyConvert, dst:ArrayBufferView, dstSize:Int, indices:ArrayBufferView, numIndices:Int, index32:Bool):Int
	{
		#if (lime_cffi && lime_bgfx && !macro)
	...
	public function getLastShaderMessage():String
	{
		#if (lime_cffi && lime_bgfx && !macro)
		return NativeCFFI.lime_bgfx_get_last_shader_message();
		#end
