...
class NativeCFFI
{
	...
	private static var lime_bgfx_dbg_text_image = CFFI.load("lime", "lime_bgfx_dbg_text_image", -1);
	...
	private static var lime_bgfx_submit_indirect_buffer = CFFI.load("lime", "lime_bgfx_submit_indirect_buffer", -1);
	private static var lime_bgfx_submit_indirect_index_buffer = CFFI.load("lime", "lime_bgfx_submit_indirect_index_buffer", -1);
	...
	private static var lime_bgfx_compile_shader_string = CFFI.load("lime", "lime_bgfx_compile_shader_string", -1);
	private static var lime_bgfx_compile_shader_file = CFFI.load("lime", "lime_bgfx_compile_shader_file", -1);
	...
	private static var lime_bgfx_create_texture_2d_scaled = CFFI.load("lime", "lime_bgfx_create_texture_2d_scaled", -1);
	private static var lime_bgfx_create_texture_3d = CFFI.load("lime", "lime_bgfx_create_texture_3d", -1);
	private static var lime_bgfx_create_texture_cube = CFFI.load("lime", "lime_bgfx_create_texture_cube", -1);
	private static var lime_bgfx_update_texture_2d = CFFI.load("lime", "lime_bgfx_update_texture_2d", -1);
	private static var lime_bgfx_update_texture_3d = CFFI.load("lime", "lime_bgfx_update_texture_3d", -1);
	private static var lime_bgfx_update_texture_cube = CFFI.load("lime", "lime_bgfx_update_texture_cube", -1);
	private static var lime_bgfx_read_texture = CFFI.load("lime", "lime_bgfx_read_texture", 3);
	private static var lime_bgfx_is_texture_valid = CFFI.load("lime", "lime_bgfx_is_texture_valid", -1);
	private static var lime_bgfx_calc_texture_size = CFFI.load("lime", "lime_bgfx_calc_texture_size", -1);
	...
	private static var lime_bgfx_dispatch = CFFI.load("lime", "lime_bgfx_dispatch", -1);
	private static var lime_bgfx_dispatch_indirect = CFFI.load("lime", "lime_bgfx_dispatch_indirect", -1);
	...
	private static var lime_bgfx_set_view_clear_mrt = CFFI.load("lime", "lime_bgfx_set_view_clear_mrt", -1);
	...
	private static var lime_bgfx_vertex_pack = CFFI.load("lime", "lime_bgfx_vertex_pack", -1);
	...
	private static var lime_bgfx_topology_convert = CFFI.load("lime", "lime_bgfx_topology_convert", -1);
	private static var lime_bgfx_topology_sort_tri_list = CFFI.load("lime", "lime_bgfx_topology_sort_tri_list", -1);
	private static var lime_bgfx_override_internal_texture = CFFI.load("lime", "lime_bgfx_override_internal_texture", -1);
