...
class NativeCFFI
{
	...
	@:cffi private static function lime_bgfx_set_vertex_buffer(stream:Int, handle:Dynamic, startVertex:Int, numVertices:Int):Void;
	@:cffi private static function lime_bgfx_set_index_buffer(handle:Dynamic, firstIndex:Int, numIndices:Int):Void;
	...
	private static var lime_bgfx_set_vertex_buffer = new cpp.Callable<Int->cpp.Object->Int->Int->cpp.Void>(cpp.Prime._loadPrime("lime", "lime_bgfx_set_vertex_buffer", "ioiiv", false));
	private static var lime_bgfx_set_index_buffer = new cpp.Callable<cpp.Object->Int->Int->cpp.Void>(cpp.Prime._loadPrime("lime", "lime_bgfx_set_index_buffer", "oiiv", false));
