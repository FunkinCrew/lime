...
class NativeCFFI
{
	...
	private static var lime_haxe_resource_init = new cpp.Callable<cpp.Object->cpp.Object->cpp.Void>(cpp.Prime._loadPrime("lime","lime_haxe_resource_init", "oov", false));
	...
	// OpenGL bindings
	#if (lime_cffi && !macro && (lime_opengl || lime_opengles) && !lime_bgfx)
	#if cpp
	...
	private static var lime_bgfx_get_last_shader_message = new cpp.Callable<Void->String>(cpp.Prime._loadPrime("lime", "lime_bgfx_get_last_shader_message", "s", false));
	...
	private static var lime_bgfx_get_last_shader_message = CFFI.load("lime", "lime_bgfx_get_last_shader_message", 0);
