...
class BGFX
{
	...
	public static inline var STENCIL_NONE = 0x0000ff00;
	...
	public static var CAPS_TEXTURE_COMPARE_RESERVED:Int64 = Int64.make(0x00000000, 0x00100000);
	...
	public static var CAPS_VIDEO_DECODE:Int64 = Int64.make(0x00000002, 0x00000000); // !< Hardware video decode is supported.
	public static var CAPS_VIEWPORT_LAYER_ARRAY:Int64 = Int64.make(0x00000004, 0x00000000);
	...
	public static inline function submitIndirectIndexBuffer(id:Int, program:BGFXProgram, ixbh:BGFXIndirectBuffer, start:Int, ibh:BGFXIndexBuffer, numMax:Int,
			depth:Int = 0, flags:Int = DISCARD_ALL):Void
	{
	...
	public static inline function dispatchIndirect(id:Int, program:BGFXProgram, ixbh:BGFXIndirectBuffer, start:Int = 0, num:Int = 1, flags:Int = 0xFF):Void
	{
	...
	public static inline function setViewClearMRT(id:Int, flags:Int, depth:Float, stencil:Int, c0:Int = 0xFF, c1:Int = 0xFF, c2:Int = 0xFF, c3:Int = 0xFF,
			c4:Int = 0xFF, c5:Int = 0xFF, c6:Int = 0xFF, c7:Int = 0xFF):Void
	{
	...
	public static inline function vertexPack(input:ArrayBufferView, inputNormalized:Bool, attrib:BGFXAttrib, layout:BGFXVertexLayout, data:ArrayBufferView,
			index:Int = 0):Void
	{
		context.vertexPack(input, inputNormalized, attrib, layout, data, index);
	}

	public static inline function vertexUnpack(output:ArrayBufferView, attrib:BGFXAttrib, layout:BGFXVertexLayout, data:ArrayBufferView, index:Int = 0):Void
	{
		context.vertexUnpack(output, attrib, layout, data, index);
	}

	public static inline function vertexConvert(dstLayout:BGFXVertexLayout, dstData:ArrayBufferView, srcLayout:BGFXVertexLayout, srcData:ArrayBufferView,
			num:Int = 1):Void
	{
		context.vertexConvert(dstLayout, dstData, srcLayout, srcData, num);
	}

	public static inline function topologyConvert(conversion:BGFXTopologyConvert, dst:ArrayBufferView, dstSize:Int, indices:ArrayBufferView, numIndices:Int,
			index32:Bool):Int
	{
	...
	public static inline function overrideInternalTexture(handle:BGFXTexture, width:Int, height:Int, numMips:Int, format:BGFXTextureFormat, flags:Int64):Float
	{
	...
	public static inline function compileShaderFile(type:BGFXShaderType, filePath:String, varyingPath:String, ?includeDirs:String = '', ?defines:String = '',
			?profile:String = ''):BGFXMemoryRef
	{
		return context.compileShaderFile(type, filePath, varyingPath, includeDirs, defines, profile);
	}

	public static inline function getLastShaderMessage():String
	{
		return context.getLastShaderMessage();
	}
