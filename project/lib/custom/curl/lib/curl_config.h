...
#if !defined(ANDROID) && !defined(HX_LINUX) && !defined(BLACKBERRY) && !defined(TIZEN)
...
#if !defined(ANDROID) && !defined(HX_LINUX) && !defined(BLACKBERRY) && !defined(TIZEN) && !defined(EMSCRIPTEN)
